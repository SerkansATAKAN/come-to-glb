...
Bu dokümantasyon, projenin mevcut yapısını ve gelecekteki ticari dönüşüm hedeflerini açıklar:

1.  **Web Platformu:** 3D Model Platformu (GLB)
2.  **AI Stüdyosu:** Prompt & Otomasyon
3.  **Desktop Tools:** Offline 3D Dönüştürücü
4.  **Gelecek Vizyonu:** Mühendislik Veri Pazarı & Nesting
...
### 1.2. Backend & Infrastructure (Firebase)
...
### 2.2. n8n İş Akışı (Backend Logic)
...
### 4.2. Otomatik Nesting & BOM (Malzeme Listesi)
...
### 4.3. AI Destekli "Mekan Giydirme"
