...
![Platform](https://img.shields.io/badge/Platform-Web%20%7C%20Desktop%20%7C%20AI-blue)
![Stack](https://img.shields.io/badge/Stack-Firebase%20%7C%20Python%20%7C%20Blender%20%7C%20n8n-orange)
...
Bu repo, aşağıdaki sistemlerin üst düzey mimarisini ve dokümantasyonunu içerir:
* Web tabanlı 3D model platformu
* AI prompt & otomasyon stüdyosu
* Offline 3D dönüştürücü masaüstü aracı

> 📚 **Detaylı teknoloji yığını ve mimari için:** [**`docs/techstack.md`**](docs/techstack.md)
...
* **Admin Paneli:**
    ...
    * Model silindiğinde Storage + Firestore’dan tam temizlik.
...
> *Detaylı roadmap için bakınız: **[`docs/techstack.md` → Bölüm 4](docs/techstack.md)**.*

* **Kısa Vadede:** Web arayüzünde gelişmiş filtreler, AI stüdyosunda "Tek Tık Reels" şablonları.
* **Orta Vadede:** GLB’den otomatik 2D teknik çizim/DXF üretimi, parça bazlı ölçü çıkarımı.
...
```text
.
├── web-platform/           # Firebase + Three.js tabanlı GLB web katmanı
│   ├── public/
│   └── firebase.json
